...
| Adapters | `js/modules/journey-compass-adapter.js`, `js/modules/semantic-lane-adapter.js`, `js/modules/view-controller-adapter.js`, `js/modules/search-panel-adapter.js` | 1.3 | No |
