...
**Catalog:** ✅ HTTP 200, 61 models. All Mistral-native models (open-mistral-nemo, mistral-medium-_, mistral-tiny-_). No V2-target models (no kimi/glm/minimax/qwen). No free models.
