...
| W3-S4      | `url-restore.ts` orchestrator                                         | ✅ DONE (~175 LOC, 866 → 690 total). Gate: `svelte-check` running.                                                                                                                                                                                                                                                                                                                                   |
| W1-Class-A | Convert 7 dead `import()` → static                                    | 📋 deferred (hygiene-only, ~0 byte win; deprioritized vs W3).                                                                                                                                                                                                                                                                                                                                        |
| W4-asset   | Serve compressed `.dat`                                               | 📋 deferred (2-4h effort).                                                                                                                                                                                                                                                                                                                                                                           |
| W4-CSS     | Delete ~520 LOC dead CSS selectors                                    | 📋 deferred (low priority).                                                                                                                                                                                                                                                                                                                                                                          |
