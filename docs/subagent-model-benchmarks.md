...
| -------------------- | ---------------- | ----------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| direct-freeinference | `kimi-k2.7-code` | ❌ Upstream-removed 2026-07-29 (NOT a cache issue)                | 2026-07-23: `Provider finish_reason: unexpected_state`. **2026-07-29 03:34Z**: main-lane session observed `cacheRead: 0` on every turn for ~5 turns. Harness auto-fell-back to `minimax-m3` after the kimi turn aborted with `stopReason: aborted, usage: all zeros`. **Root cause confirmed via upstream `/v1/models` probe**: the slug `kimi-k2.7-code` is **NOT enumerated in the live `freeinference.org/v1/models` catalog** (only 7 models listed — `bge-m3`, `deepseek-v4-flash`, `diffusiongemma`, `glm-5.1`, `minimax-m2.5`, `minimax-m3`, `qwen3.6-35b`). No replacement slug (`kimi-k2.8`, `kimi-k3`) exists either. The 0-cache + Request-aborted pattern was the upstream routing the call to a stale slug → failing mid-stream → harness defaulting `cacheRead: 0`. Earlier today (~00:00-00:02Z) kimi-k2.7-code was hitting **99.4–99.7% cache** (PID 19120: 129,664 / 130,419 → 130,240 / 130,640 → 130,432 / 147,132 → 146,560 / 147,442) — that means the model was healthy at that time and got retired sometime between 00:02Z and 03:34Z. **Fix**: remove the kimi-k2.7-code entry from `~/.pi/agent/model-providers.json` (or update it to point at `minimax-m3` as the new freeinference main-lane route). Do NOT re-test kimi-k2.7-code — the slug is gone. |
