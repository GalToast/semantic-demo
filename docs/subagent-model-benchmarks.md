...
| target route                         | runner model                                    | result                  | report file                                                                               | notes                                                                                                              |
| ------------------------------------ | ----------------------------------------------- | ----------------------- | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| `openrouter/openai/gpt-oss-20b:free` | `kilo/stepfun/step-3.7-flash:free`              | ✅ completed            | `tmp/subagent-benchmark/reports/openrouter-gpt-oss-20b-free-threadinspector-dom-audit.md` | Clean read+write; ~90 s. Runner step-3.7-flash performed well on a simple read-only task.                           |
| `logfare/kimi-k2.6`                  | `logfare/glm-5.2`                               | ❌ timeout              | —                                                                                         | Worker overcomplicated task (tried to launch nested subagents), hit 300 s cap.                                        |
| `logfare/kimi-k2.6`                  | `kilo/stepfun/step-3.7-flash:free`              | ❌ timeout              | —                                                                                         | Re-dispatch with direct read-only prompt: zero assistant output in 300 s. `logfare/kimi-k2.6` not subagent-viable right now. |
...
**New viable route added:** `openrouter/openai/gpt-oss-20b:free` (HTTP smoke ✅, subagent dispatch ✅, simple tool-use ✅).
