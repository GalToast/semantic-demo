...
assert(
  itemSrc.includes("import { getSearchResultStrength, getSearchResultCardClasses } from '@lib/search/result-presentation';"),
...
assert(
  itemSrc.includes('topScore, isAnchor, onClick') || itemSrc.includes('topScore,\n      isAnchor,\n      onClick') || itemSrc.includes('topScore, isAnchor'),
