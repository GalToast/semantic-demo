 ...
 *
 * Proves that all direct writes of selectedPoint, focusedNode, navState fields,
 * and trailIndices inside search-state.js are contained inside the named helper
 * `clearSearchRelatedFocusState`.  No other function in search-state.js may
 * directly assign to those fields.
 *
