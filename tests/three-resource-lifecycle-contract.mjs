...
function testResourceDiagnostics() {
    ...
    assertContains(engineSrc, 'const resources = getLiveResourceCounts()', 'Diagnostics calls getLiveResourceCounts');
    assertContains(engineSrc, 'memory: resources', 'Diagnostics includes memory stats');
