...
class FakeElement {
    ...
    querySelector(selector) {
        const className = selector.split(/\s+/).at(-1)?.replace(/^\./, '')
...
const { getSearchResultStrength, getSearchResultStrengthLabel } = await import('../src/lib/search/result-renderer.ts')
