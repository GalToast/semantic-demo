...
export class TestParamPropPrivate {
    ...
    getFoo(): string { return this.foo }
}

export class TestParamPropPublicDefault {
    constructor(public x = 1, private y: number) {}
...
export class TestMultiParamProp {
    constructor(private a: string, private b: number, private flag: boolean) {}
...
export class TestDefaultThenPrivate {
    ...
    constructor(opt = 'DEFAULT', flag = true) { this.opt = opt; this.flag = flag }
    getFlag(): boolean { return this.flag }
}
