...
for (const vp of VIEWPORTS) {
  ...
  test.describe(`short-landscape viewport contracts at ${vpString}`, () => {
    ...
    test(`search bar visible and not overflowing at ${vpString}`, async ({ page }) => {
    ...
    test(`info panel visible and not overflowing at ${vpString}`, async ({ page }) => {
      await page.setViewportSize(vp);
    ...
    test(`layout adapts correctly at short-landscape ${vpString}`, async ({ page }) => {
      await page.setViewportSize(vp);
    ...
    test(`no viewport overflow on any key element at ${vpString}`, async ({ page }) => {
      await page.setViewportSize(vp);
      await page.waitForLoadState('networkidle');
      await page.evaluate(() => {
    ...
    test(`focus card leaves graph breathing room at ${vpString}`, async ({ page }) => {
      await page.setViewportSize(vp);
      await page.evaluate(() => {
