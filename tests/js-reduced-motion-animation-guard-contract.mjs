...
assertContains(searchAnimSrc, "import { prefersReducedMotion } from '@lib/utils/environment'", 'three-search-animations imports prefersReducedMotion')
assertContains(searchAnimSrc, 'const reducedMotion = prefersReducedMotion()', 'three-search-animations computes reducedMotion')
