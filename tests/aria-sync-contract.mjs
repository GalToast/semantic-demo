...
function commit(label) {
    ...
    console.log(
        `  [${label}] panelSurface=${ds('panelSurface')} semanticDive=${ds('semanticDive')} graphContext=${ds('graphContext')} trailState=${ds('trailState')}`
    )
}
...
assert(ARIA_BY_STATE['idle']['#legend']['aria-hidden'] === 'false', 'overview: legend aria-hidden should be false')
...
assert(
    ARIA_BY_STATE['search']['#info-panel']['aria-expanded'] === 'true',
    'search: info-panel aria-expanded should be true (search results)'
)
assert(
    ARIA_BY_STATE['search']['#focus-stage']['aria-hidden'] === 'true',
...
assert(
    ARIA_BY_STATE['focus-search']['#focus-stage']['aria-hidden'] === 'false',
    'focus: focus-stage aria-hidden should be false (now visible)'
)
assert(
    ARIA_BY_STATE['focus-search']['#focus-stage']['aria-expanded'] === 'true',
...
assert(
    ARIA_BY_STATE['semantic-dive']['#legend']['aria-hidden'] === 'true',
    'semantic-dive: legend aria-hidden should be true (obscured by dive UI)'
)
assert(
    ARIA_BY_STATE['semantic-dive']['#focus-stage']['aria-hidden'] === 'false',
...
assert(
    ARIA_BY_STATE['focus']['#focus-stage']['aria-hidden'] === 'false',
...
assert(
    ARIA_BY_STATE['map-focus-search']['#focus-stage']['aria-hidden'] === 'true',
...
assert(ARIA_BY_STATE['idle']['#focus-stage']['aria-hidden'] === 'true', 'short-input: focus-stage remains hidden')
