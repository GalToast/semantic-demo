...
import { PARITY_ATTRIBUTES, PARITY_ATTRIBUTE_KEYS } from '@lib/orchestration/parity-attrs.svelte'
...
describe('camera/url-state/parity-attrs constants — Phase 6c extension', () => {
    ...
    describe('CAMERA_CONFIG', () => {
        ...
        it('FREE orbit speed is greater than DEFAULT orbit speed', () => {
            ...
            expect(CAMERA_CONFIG.ORBIT_ROTATE_SPEED_FREE).toBeGreaterThan(CAMERA_CONFIG.ORBIT_ROTATE_SPEED_DEFAULT)
            expect(CAMERA_CONFIG.ORBIT_PAN_SPEED_FREE).toBeGreaterThan(CAMERA_CONFIG.ORBIT_PAN_SPEED_DEFAULT)
        })
    })
    ...
    describe('PARITY_ATTRIBUTES manifest', () => {
        ...
        it('covers expected journey/compass attribute keys (sanity for CSS hooks)', () => {
            ...
            const expectedKeys = ['journeyCompassPhase', 'navMode', 'navSurface']
