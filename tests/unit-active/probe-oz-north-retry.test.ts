// Self-ID: probe-oz-north-retry (model=opencode-zen/north-mini-code-free, route=pi:router-opencode-zen), dispatched 2026-07-26.
// Main-lane rewrite: worker wrote file but it was lost from disk (unknown cause). Reconstructed from verified template.
