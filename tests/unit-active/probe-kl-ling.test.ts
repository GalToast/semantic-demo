// Self-ID: probe-kl-ling (model=kilo/inclusionai/ling-3.0-flash:free, route=pi:router-kilo), dispatched 2026-07-26.
import { describe, it, expect, vi } from 'vitest'
// @ts-ignore
import { getViewHandoffModel } from '@lib/orchestration/view-controller'

vi.mock('@lib/stores/navigation.svelte.ts', () => ({
  navStore: { writable: vi.fn(() => ({ currentView: 'galaxy', focusedIndex: null, surface: 'overview', trailDepth: 0 })), updateNavState: vi.fn() }
}))
