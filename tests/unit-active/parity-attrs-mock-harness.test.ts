...
vi.mock('@lib/state/app.svelte.ts', () => ({
  appState: {
    ...
    set navState(v) { mockState.navState = v as typeof mockState.navState },
    get currentView() { return mockState.navState.currentView },
    set currentView(v) {},
...
vi.mock('@lib/stores/navigation.svelte', () => ({
  navStore: Object.assign(
    () => mockState.navState,
    {
      ...
      set: (v: typeof mockState.navState) => { mockState.navState = v },
      subscribe: (fn: (v: typeof mockState.navState) => void) => {
        fn(mockState.navState); return () => {}
      }
    }
  )
}))
...
vi.mock('@lib/stores/journey.svelte', () => ({
  journeyStore: Object.assign(
    () => mockState.journeyState,
    {
      ...
      subscribe: (fn: (v: typeof mockState.journeyState) => void) => {
        fn(mockState.journeyState); return () => {}
      }
    }
  )
}))
  ...
  focusStore: Object.assign(
    () => mockState.focusState,
    {
      ...
      subscribe: (fn: (v: typeof mockState.focusState) => void) => {
        fn(mockState.focusState); return () => {}
      }
    }
  )
}))
...
vi.mock('@lib/stores/search.svelte', () => ({
  searchStore: Object.assign(
    () => mockState.searchState,
    {
      ...
      set: (v: typeof mockState.searchState) => { mockState.searchState = v },
      subscribe: (fn: (v: typeof mockState.searchState) => void) => {
        fn(mockState.searchState); return () => {}
      }
    }
  )
}))
  ...
  filterState: Object.assign(
    () => mockState.filterState,
    {
      ...
      subscribe: (fn: (v: typeof mockState.filterState) => void) => {
        fn(mockState.filterState); return () => {}
      }
    }
  )
}))
  ...
  viewport: Object.assign(
    () => mockState.viewportState,
    {
      ...
      subscribe: (fn: (v: typeof mockState.viewportState) => void) => {
        fn(mockState.viewportState); return () => {}
      }
    }
  )
}))
  ...
  cameraStore: Object.assign(
    () => mockState.cameraState,
    {
      ...
      subscribe: (fn: (v: typeof mockState.cameraState) => void) => {
        fn(mockState.cameraState); return () => {}
      }
    }
  )
}))
...
vi.mock('@lib/stores/engine-ready.svelte', () => ({
  engineReady: {
    get value() { return mockState.engineReadyValue },
    subscribe: (fn: (v: boolean) => void) => { fn(mockState.engineReadyValue); return () => {} }
  }
}))

vi.mock('@lib/data-store', () => ({
  graphicsModeStore: Object.assign(
    () => mockState.graphicsMode,
    {
      update: () => {},
      set: (v: string) => { mockState.graphicsMode = v },
      subscribe: (fn: (v: string) => void) => { fn(mockState.graphicsMode); return () => {} }
    }
  ),
  loadingPhaseStore: Object.assign(
    () => mockState.loadingPhase,
    {
      update: () => {},
      set: (v: string) => { mockState.loadingPhase = v },
      subscribe: (fn: (v: string) => void) => { fn(mockState.loadingPhase); return () => {} }
    }
  )
}))
