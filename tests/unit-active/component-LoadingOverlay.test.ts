 ...
 *  3. Overlay has data-loading-phase and data-loading-state="active" attributes
 *  4. Renders .loading-shell with .loading-kicker, .loading-title, .loading-note
 *  5. Renders #loading-progress-bar fill element inside .loading-bar-track
...
describe('LoadingOverlay component', () => {
    ...
    it('overlay has data-loading-phase and data-loading-state="active"', () => {
        const { container } = render(LoadingOverlay);
        const overlay = container.querySelector('#loading-overlay');
