...
vi.mock('@lib/state/app.svelte.ts', () => ({
    appState: {
        ...
        viewportState: {
            get viewportWidth() {
                return _viewportState.viewportWidth
            },
            set viewportWidth(v: number) {
                _viewportState.viewportWidth = v
            },
            get viewportHeight() {
                return _viewportState.viewportHeight
            },
            set viewportHeight(v: number) {
                _viewportState.viewportHeight = v
            },
            get viewportDpr() {
                return _viewportState.viewportDpr
            },
            set viewportDpr(v: number) {
                _viewportState.viewportDpr = v
            },
            get viewportReducedMotion() {
                return _viewportState.viewportReducedMotion
            },
            set viewportReducedMotion(v: boolean) {
                _viewportState.viewportReducedMotion = v
            },
            get viewportIsCompact() {
                return _viewportState.viewportIsCompact
            },
            set viewportIsCompact(v: boolean) {
                _viewportState.viewportIsCompact = v
            }
        },
