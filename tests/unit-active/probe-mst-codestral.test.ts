// Self-ID: probe-mst-codestral (model=mistral/codestral-latest, route=pi:router-mistral), dispatched 2026-07-26.
// Main-lane fix: worker used require() inside describe() and vi.mock inside describe() — both invalid. Rewritten with ES module imports + top-level vi.mock.
