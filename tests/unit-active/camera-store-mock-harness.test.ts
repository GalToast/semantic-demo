...
vi.mock('@lib/state/app.svelte.ts', () => ({
  appState: {
    ...
    set autoRotate(v) { mockState.autoRotate = v },
    get autoRotateSuspended() { return mockState.autoRotateSuspended },
    set autoRotateSuspended(v) { mockState.autoRotateSuspended = v },
    get autoRotateResumeDueAt() { return mockState.autoRotateResumeDueAt },
    set autoRotateResumeDueAt(v) { mockState.autoRotateResumeDueAt = v },
    get autoRotateSoftResumeStartedAt() { return mockState.autoRotateSoftResumeStartedAt },
    set autoRotateSoftResumeStartedAt(v) { mockState.autoRotateSoftResumeStartedAt = v },
