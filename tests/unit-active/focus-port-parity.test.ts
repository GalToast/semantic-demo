 ...
 *
 * The 2 newly ported focus subsystem files in src/lib/focus/ (anchor-indicator
 * and stage-renderer) must behave functionally identically to their
 ...
 * (anchor-indicator's surface sync, the rest of stage-renderer's
...
const SAMPLE_POINTS: ReadonlyArray<{ readonly label: string; readonly point: unknown }> = [
    ...
    {
        label: 'point with everything',
        point: { email: 'a@b.com', phone: '555-1234', website: 'https://example.com', trivia: 'Family-owned nursery.' }
    },
