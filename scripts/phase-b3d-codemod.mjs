...
for (const relPath of CSS_FILES) {
    ...
    if (out !== src) {
        ...
        console.log(`  ${relPath}: ${changes} rules (${filePanelSurface} panel-surface + ${filePanelSurfacePrefix} panel-surface^ + ${fileActiveView} active-view)`);
        if (!DRY_RUN) {
