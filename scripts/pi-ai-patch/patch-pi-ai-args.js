...
const root = 'C:/Users/HP/AppData/Roaming/npm/node_modules/@earendil-works/pi-coding-agent/node_modules/@earendil-works/pi-ai/dist';
...
if (!jsonParse.includes(oldParse)) {
    console.error('PATCH FAILED: could not find old parseStreamingJson in json-parse.js');
    process.exit(1);
}
...
if (!openai.includes(oldArgs)) {
    console.error('PATCH FAILED: could not find old tool-call args accumulation in openai-completions.js');
    process.exit(1);
}
