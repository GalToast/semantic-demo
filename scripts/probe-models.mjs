...
function targets() {
    const t = {
        logfare: [
            ...
            { id: 'kimi-k2.7-code', note: 'ok NS3213_ST3474' },
            { id: 'kimi-k2.6', note: 'tested-slow' },
            { id: 'deepseek-v4-flash', note: 'ok NS4840_ST3524' }
        ],
        kilo: [
            { id: 'meta/muse-spark-1.1', note: '402 no credits' },
            { id: 'moonshotai/kimi-k3', note: 'ok NS871 (no tools)' },
            { id: 'thinkingmachines/inkling', note: '402 no credits' },
            { id: 'poolside/laguna-s-2.1', note: 'free' },
            { id: 'google/gemini-3.6-flash', note: 'ok NS1521_ST1232' },
            { id: 'google/gemini-3.5-flash-lite', note: 'ok NS1501_ST1185' },
            { id: 'anthropic/claude-opus-5-fast', note: '402 no credits' },
            { id: 'stepfun/step-3.7-flash:free', note: 'ok NS2876_ST3253' },
            { id: 'inclusionai/ling-3.0-flash:free', note: 'ok NS1180_ST2534' },
            { id: 'minimax/minimax-m3', note: 'TIMEOUT' }
        ],
        cloudflare: [
            { id: '@cf/openai/gpt-oss-20b', note: 'ok NS839_ST642' },
            { id: '@cf/openai/gpt-oss-120b', note: 'ok NS756_ST807' },
            { id: '@cf/moonshotai/kimi-k2.6', note: 'ok NS4856 (ST timeout)' },
            { id: '@cf/zai-org/glm-4.7-flash', note: 'ok NS3339_ST2012' },
            { id: '@cf/nvidia/nemotron-3-120b-a12b', note: 'ok NS1080_ST1073' },
            { id: '@cf/google/gemma-4-26b-a4b-it', note: 'ok NS3836_ST1465' },
            { id: '@cf/mistralai/mistral-small-3.1-24b-instruct', note: 'ok NS817_ST3259' },
            { id: '@cf/meta/llama-4-scout-17b-16e-instruct', note: 'ok NS842_ST638' },
            { id: '@cf/meta/llama-3.3-70b-instruct-fp8-fast', note: 'ok NS1274_ST9617' },
            { id: '@cf/qwen/qwen3-30b-a3b-fp8', note: 'ok NS492_ST511' },
            { id: '@cf/qwen/qwq-32b', note: 'ok NS826_ST768' },
            { id: '@cf/qwen/qwen2.5-coder-32b-instruct', note: 'ok NS749_ST852' },
            { id: '@cf/deepseek-ai/deepseek-r1-distill-qwen-32b', note: 'ok NS12971_ST6687' },
            { id: '@cf/ibm-granite/granite-4.0-h-micro', note: 'ok NS1341_ST1245' },
            { id: '@cf/aisingapore/gemma-sea-lion-v4-27b-it', note: 'ok NS155 (ST 400 error)' }
        ],
        groq: [
            { id: 'llama-3.3-70b-versatile', note: 'ok NS620_ST419' },
            { id: 'llama-3.1-8b-instant', note: 'ok NS423_ST281' },
            { id: 'openai/gpt-oss-20b', note: 'ok NS283_ST220' },
            { id: 'openai/gpt-oss-120b', note: 'ok NS449_ST352' },
            { id: 'groq/compound', note: '400 no tool support' },
            { id: 'groq/compound-mini', note: '400 no tool support' },
            { id: 'qwen/qwen3.6-27b', note: 'ok NS826_ST713' }
        ],
        openrouter: [
            { id: 'google/gemini-3.5-flash', note: 'ok NS2549_ST1350' },
            { id: 'google/gemini-3.1-pro-preview', note: 'ok NS1366_ST1223' },
            { id: 'google/gemma-4-31b-it', note: '402 no credits' },
            { id: 'openai/gpt-oss-120b', note: '402 no credits' },
            { id: 'openai/gpt-oss-20b', note: '402 no credits' }
        ],
        nvidia: [
        ...
        siliconflow: [{ id: 'deepseek-ai/deepseek-r1', note: '503 router has no configured keys' }],
        together: [{ id: 'deepseek-ai/deepseek-v3', note: '503 router has no configured keys' }],
        cerebras: [{ id: 'llama3.3-70b', note: '503 router has no configured keys' }],
        cohere: [{ id: 'command-r-plus', note: '503 router has no configured keys' }],
        hyperbolic: [{ id: 'meta-llama/Llama-3.1-70B-Instruct', note: '503 router has no configured keys' }],
        novita: [{ id: 'meta-llama/llama-3.1-8b-instruct', note: '503 router has no configured keys' }],
        aimlapi: [{ id: 'gpt-4o', note: '503 router has no configured keys' }]
    }
