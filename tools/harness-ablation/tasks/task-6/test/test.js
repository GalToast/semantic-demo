...
assert(
    JSON.stringify(slidingMax3([1, 5, 3])) === JSON.stringify([5, 5, 3]),
    'window of 3 over 3 elems (last window [3])'
)
assert(
    JSON.stringify(slidingMax3([1, 5, 3, 2])) === JSON.stringify([5, 5, 3, 2]),
    '4 elems: windows [1,5,3],[5,3,2],[3,2],[2]'
)
