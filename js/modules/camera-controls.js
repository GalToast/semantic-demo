...
function computeTravelVectorHeading(focusTarget, currentHeading, transitionStyle, framing) {
...
function computeOrbitBiasHeading(currentHeading, transitionStyle, pocketProfile) {
...
function computeCameraArcControlPoints(startPos, startTarget, desiredCamPos, focusTarget, currentHeading, distance, transitionStyle, personality, pocketProfile, stageRightVector) {
    const worldUp = new THREE.Vector3(0, 1, 0);
