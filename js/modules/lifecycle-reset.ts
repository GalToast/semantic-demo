...
import { clearSearchGlow, setSearchPanelState, updateSearchStatusMessage } from '@lib/engine/search-state-bridge'
...
export function resetExplorationFocus(
    ...
    const preservedSearchSummary = options.preserveSearch === false ? null : appState.currentSearchSummary
