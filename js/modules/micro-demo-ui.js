...
export function showVeil(active) {
...
export function bindInputInterceptor(onCancel) {
...
export function unbindInputInterceptor() {
    if (_inputCleanup) _inputCleanup();
}

export function showPill(text, onSkip) {
...
export function injectMicroDemoStyles() {
