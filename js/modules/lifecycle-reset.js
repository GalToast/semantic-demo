// lifecycle-reset.js — Reset/overview functions and their declarative event subscriptions
import { state, withStateMutation } from '../state.js';
import { publish, subscribe, EVENTS } from './event-bus.js';
import { clearExplorationFocusSelection } from './url-state.js';
...
import { clearNavigationFocusState, clearTrailThreadState } from './navigation-state.js';
import {
  clearSearchGlow,
  setSearchPanelState,
  updateSearchStatusMessage
} from './search-state.js';
import { settleCameraToOverviewPose } from './camera-controls.js';
import {
  getCurrentView, getCurrentSearchSummary, getSearchGlowIndices
} from '../state/selectors/index.js';
import { refreshCompositionState, updateExplorationUi } from './lifecycle-modes.js';
