 ...
 */
import * as core from '@lib/engine/camera-controls-core'
import * as restore from '@lib/engine/camera-controls-restore-bridge'
import * as choreography from '@lib/engine/camera-choreography'
...
export function cancelFocusCameraAnimation(): any {
    return (choreography as any).cancelFocusCameraAnimation()
}
