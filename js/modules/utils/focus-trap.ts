 ...
 * focus-trap.ts
 *
 * Focus trap for accessibility: constrains Tab key cycling within a set of
 * container selectors so modal/overlay UIs remain keyboard-accessible.
 */
 ...
 *
 * @param containerSelectors Array of CSS selectors for container elements
 */
