// @ts-nocheck
/**
 * semantic-search-api-cache.ts
 *
 * Typed sibling of semantic-search-api-cache.js.
 * Manages the semantic search API call with retry logic, timeout, and
...
interface SemanticSearchRetryInfo {
    attempt: number;
    nextAttempt: number;
    delayMs: number;
    retryTotal: number;
