 ...
 * Centralized module for building and updating HTML strings and DOM components.
 * Split from js/modules/search-state.js and js/modules/lifecycle.js (Seam #2).
 */
...
export function getInterestingBusinessNote(point) {
    ...
    if (point.trivia) {
        ...
        // Suppress verification-system outputs that read like legal/entity confirmation
