...
// Implementation uses runtime Proxy patterns that are difficult to model precisely
// in TypeScript's type system; intrinsic types are provided via types/state.d.ts
// and src/lib/state/with-state-mutation.ts.  During migration this file is the
// source of truth for the state singleton; js/state.js re-exports from here.
...
export const _rawState = {
    ...
    strandContinuityState: {
        ...
        startedAt: 0, arrivalTimeoutId: null, settleTimeoutId: null
    },
