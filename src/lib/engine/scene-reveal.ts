...
import { state, type SemanticState } from '@legacy/state';
...
import { syncClusterSectionState } from '@legacy/modules/cluster-labels';
import { updateTraversalUi } from '@legacy/modules/journey';
