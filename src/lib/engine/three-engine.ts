...
async function _ensureModules(): Promise<void> {
  ...
  try {
    const [
      ...
      import(/* @vite-ignore */ '@legacy/state'),
      import(/* @vite-ignore */ '@legacy/modules/view-controller'),
      import(/* @vite-ignore */ '@legacy/modules/cluster-labels'),
      import(/* @vite-ignore */ '@legacy/modules/focus-pocket'),
      import(/* @vite-ignore */ '@legacy/modules/scene-reveal'),
      import(/* @vite-ignore */ '@legacy/modules/camera-controls'),
      import(/* @vite-ignore */ '@legacy/modules/map-state'),
      import(/* @vite-ignore */ '@legacy/modules/mycelium-engine'),
      import(/* @vite-ignore */ '@legacy/modules/ui-feedback'),
      import(/* @vite-ignore */ '@legacy/modules/map-flattening-layout'),
      import(/* @vite-ignore */ '@legacy/modules/webgl-restore-adapter'),
      import(/* @vite-ignore */ '@legacy/modules/inspected-strand-overlay-adapter'),
      import(/* @vite-ignore */ '@legacy/modules/focus-anchor-indicator'),
      import(/* @vite-ignore */ '@legacy/modules/route-arrival-overlay-adapter'),
      import(/* @vite-ignore */ '@legacy/modules/three-node-manager'),
      import(/* @vite-ignore */ '@legacy/modules/three-thread-manager'),
      import(/* @vite-ignore */ '@legacy/modules/three-search-animations'),
      import(/* @vite-ignore */ '@legacy/modules/audio-scape'),
      import(/* @vite-ignore */ '@legacy/modules/event-bindings'),
      import(/* @vite-ignore */ '@legacy/modules/loading-ui'),
      import(/* @vite-ignore */ '@legacy/modules/three-interaction-visuals'),
    ]);
