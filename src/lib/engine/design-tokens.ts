...
export const CORRIDOR_TRAIL_SHADER_COLORS = {
  teal: '0.43, 1.0, 0.91',
  ember: '0.74, 0.86, 0.68',
} as const;

export const ROUTE_TRACE_COLORS = {
  route: 0x4ecdc4,
  cue: 0xffdf6e,
} as const;

export const FOCUS_SEMANTIC_COLORS = {
  focusLerp: 0xffd66b,
  cue: 0xffe27a,
  candidate: 0x56d8d1,
} as const;
...
export const CLUSTER_COLORS = [
  ...
  '#a29bfe', '#fdcb6e', '#e84393', '#00cec9', '#6c5ce7',
  '#fab1a0', '#81ecec', '#55efc4', '#ffeaa7', '#dfe6e9',
  '#ff7675', '#fd79a8', '#00b894', '#e17055',
] as const;
