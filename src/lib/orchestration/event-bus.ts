...
export const EVENTS = {
    ...
    SEARCH_MOCK_FALLBACK: 'SEARCH_MOCK_FALLBACK',
...
export interface EventPayloads {
    ...
    [EVENTS.SEARCH_MOCK_FALLBACK]: Record<string, unknown>
 ...
 */
export function subscribe<K extends EventName>(eventName: K, callback: Callback<EventPayloads[K]>): () => void {
 ...
 */
export function publish<K extends EventName>(eventName: K, payload: EventPayloads[K] = {} as EventPayloads[K]): void {
    const callbacks = _subscribers.get(eventName)
