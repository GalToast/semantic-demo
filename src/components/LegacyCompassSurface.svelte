...
<style>
  ...
  :global(body[data-panel-surface='map-trail']) .map-trail-strip,
  ...
  :global(body[data-panel-surface='map-trail'] .map-strip-title),
  :global(
      body[data-panel-surface='map-search'][data-trail-state='active'][data-journey-navigation-owner='map-trail-strip']
        .map-strip-title
    ) {
    position: static;
    inset: auto;
